      ...
      <div className="w-full max-w-4xl">
        ...
        <BlurFade delay={0.1} inView>
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center p-3 mb-6 rounded-full bg-white/5 border border-white/10 shadow-[0_0_15px_rgba(59,130,246,0.5)]">
        ...
        <div className="space-y-12">
          ...
          <BlurFade delay={0.2} inView>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl bg-white/5 border border-white/10 text-center hover:bg-white/10 transition-colors duration-300">
