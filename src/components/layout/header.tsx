    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2 z-50 group">
          ...
          {/* REMOVIDO 'hidden sm:block' PARA APARECER NO MOBILE */}
          <span className={cn(
            "font-display font-bold text-xl tracking-tight block transition-colors",
            isScrolled ? "text-foreground group-hover:text-primary" : "text-white group-hover:text-white"
          )}>
        ...
        {/* 3. BUSCA (Desktop) */}
        <div className="hidden md:flex flex-1 max-w-[200px] lg:max-w-xs ml-auto mr-4">
          <form onSubmit={handleSearch} className="relative w-full group">
            ...
            <Input 
              ...
              className={cn(
                ...
                "bg-white border-gray-200 text-foreground placeholder:text-muted-foreground focus-visible:ring-primary focus-visible:border-primary",
                    ...
                    <form onSubmit={handleSearch} className="relative">
                      ...
                      <Input 
                        ...
                        className={cn(
                          ...
                          "bg-white border-gray-200 text-foreground placeholder:text-muted-foreground focus-visible:ring-primary",
